  ...
  return (
    <div>
      ...
      <section className="how-it-works">
        ...
        <div className="cards">
          ...
          <div className="card">
            ...
            <h3>Apply & Work</h3>
            <p>
              Submit proposals, collaborate with clients, and complete projects.
            </p>
          </div>
          <div className="card">
      ...
      <section className="success-stories">
        ...
        <div className="story-cards">
          <div className="story-card">
            ...
            <p>
              Sarah, a computer science student, landed her first web
              development project through KaamDaam. She gained valuable
              experience and built a strong portfolio.
            </p>
          </div>
          <div className="story-card">
      ...
      <section className="cta-section">
        ...
        <p>
          Join KaamDaam today and start your journey as a freelance
          professional.
        </p>
